...
import com.blake.pmis.dto.*;
import com.blake.pmis.entity.*;
import com.blake.pmis.entity.enumaration.ProjectPriority;
import com.blake.pmis.entity.enumaration.ProjectStatus;
import com.blake.pmis.repository.*;
...
public class ProjectService {
    ...
    public List<ProjectDTO> getProjectsForUser(Long userId) {
        ...
        if (user.getRole() == com.blake.pmis.entity.enumeration.Role.ADMIN) {
            return projectRepository.findAll().stream()
                    .map(this::convertToDTO)
                    .collect(Collectors.toList());
        }
